  ...
  return (
    <div className="p-4 space-y-6">
      <header className="flex items-center justify-between py-2">
        <div>
          <h1 className="text-2xl font-bold text-primary">宠伴</h1>
          <p className="text-sm text-gray-500">遛宠路线分享平台</p>
        </div>
      ...
      {/* 打卡功能 - 最前面最中心 */}
      <div className="bg-gradient-to-r from-primary to-orange-400 rounded-2xl p-6 text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-sm opacity-90 mb-4">记录你的遛宠路线，分享精彩瞬间</p>
          <button
      ...
      <div className="grid grid-cols-3 gap-3">
        {[
          ...
          <div key={idx} className={`${stat.color} rounded-xl p-3 text-center`}>
      ...
      <section>
        ...
        <div className="space-y-4">
          {routes.slice(0, 3).map((route) => (
            <Link to={`/route/${route.id}`} key={route.id} className="block bg-white rounded-2xl shadow-sm overflow-hidden">
